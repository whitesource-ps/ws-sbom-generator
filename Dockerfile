...
CMD ["python","/opt/ws-sbom-generator/ws_sbom_generator/sbom_generator.py","-o /opt/ws-sbom-generator/sbom_generator/output","-e /opt/ws-sbom-generator/sbom_generator/resources/sbom_extra.json"]
