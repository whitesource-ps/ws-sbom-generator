...
def parse_args():
    ...
    parser.add_argument('-lt', '--license_text', help="Include license text for each element", dest='lic_text', default=False, type=bool)
    parser.add_argument('-lt_n', '--licensetext', help="Include license text for each element", dest='lictext', default=False, type=bool)
    ...
    if not arguments.lictext:
        arguments.lictext = arguments.lic_text # --licensetext is main parameter. The --license_text is INTERNAL. We use it if customer uses old syntax (-lt or --license_text)
